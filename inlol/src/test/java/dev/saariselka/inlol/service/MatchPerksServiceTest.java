...
public class MatchPerksServiceTest {
    ...
    void findByMatchPerksId() {
        ...
        // when
        List<MatchPerksVO> matchPerksVOList =
                matchPerksService.findByMatchPerksId(
                        new MatchPerksId("KR_9999999999", "ccqTGM6gk-LlPZyyQFW-igW1ENV-hkic4NZ636GGAmLQ4ENlnf0tVS5Z3LddB49pKLFj1aEXpea4Nw"));
        MatchPerksVO test = matchPerksVOList.get(0);

        // then
        assertThat(test.getMatchId()).isEqualTo("KR_9999999999");
        assertThat(test.getPuuid()).isEqualTo("ccqTGM6gk-LlPZyyQFW-igW1ENV-hkic4NZ636GGAmLQ4ENlnf0tVS5Z3LddB49pKLFj1aEXpea4Nw");
