...
public class Challenges extends BaseInfo {
    ...
    public Challenges(int assistStreakCount, int abilityUses, int acesBefore15Minutes, int alliedJungleMonsterKills, int baronTakedown, int blastConeOppositeOpponentCount, int bountyGold, int buffsStolen, int completeSupportQuestInTime, int controlWardsPlaced, int damagePerMinute, int damageTakenOnTeamPercentage, int dancedWithRiftHerald, int deathsByEnemyChamps, int dodgeSkillShotsSmallWindow, int doubleAces, int dragonTakedowns, int earlyLaningPhaseGoldExpAdvantage, int effectiveHealAndShielding, int elderDragonKillsWithOpposingSoul, int elderDragonMultikills, int enemyChampionImmobilizations, int enemyJungleMonsterKills, int epicMonsterKillsNearEnemyJungler, int epicMonsterKillsWithin30SecondsOfSpawn, int epicMonsterSteals, int epicMonsterStolenWithoutSmite, int flawlessAces, int fullTeamTakedown, int gameLength, int getTakedownsInAllLanesEarlyJungleAsLaner, int goldPerMinute, int hadOpenNexus, int immobilizeAndKillWithAlly, int initialBuffCount, int initialCrabCount, int jungleCsBefore10Minutes, int junglerTakedownsNearDamagedEpicMonster, int kTurretsDestroyedBeforePlatesFall, int kda, int killAfterHiddenWithAlly, int killParticipation, int killedChampTookFullTeamDamageSurvived, int killsNearEnemyTurret, int killsOnOtherLanesEarlyJungleAsLaner, int killsOnRecentlyHealedByAramPack, int killsUnderOwnTurret, int killsWithHelpFromEpicMonster, int knockEnemyIntoTeamAndKill, int landSkillShotsEarlyGame, int laneMinionsFirst10Minutes, int laningPhaseGoldExpAdvantage, int legendaryCount, int lostAnInhibitor, int maxCsAdvantageOnLaneOpponent, int maxKillDeficit, int maxLevelLeadLaneOpponent, int moreEnemyJungleThanOpponent, int multiKillOneSpell, int multiTurretRiftHeraldCount, int multikills, int multikillsAfterAggressiveFlash, int mythicItemUsed, int outerTurretExecutesBefore10Minutes, int outnumberedKills, int outnumberedNexusKill, int perfectDragonSoulsTaken, int perfectGame, int pickKillWithAlly, int playedChampSelectPosition, int poroExplosions, int quickCleanse, int quickFirstTurret, int quickSoloKills, int riftHeraldTakedowns, int saveAllyFromDeath, int scuttleCrabKills, int skillshotsDodged, int skillshotsHit, int snowballsHit, int soloBaronKills, int soloKills, int stealthWardsPlaced, int survivedSingleDigitHpCount, int survivedThreeImmobilizesInFight, int takedownOnFirstTurret, int takedowns, int takedownsAfterGainingLevelAdvantage, int takedownsBeforeJungleMinionSpawn, int takedownsFirstXMinutes, int takedownsInAlcove, int takedownsInEnemyFountain, int teamBaronKills, int teamDamagePercentage, int teamElderDragonKills, int teamRiftHeraldKills, int threeWardsOneSweeperCount, int tookLargeDamageSurvived, int turretPlatesTaken, int turretTakedowns, int turretsTakenWithRiftHerald, int twentyMinionsIn3SecondsCount, int unseenRecalls, int visionScoreAdvantageLaneOpponent, int visionScorePerMinute, int wardTakedowns, int wardTakedownsBefore20M, int wardsGuarded, Participant participant) {
        ...
        this.baronTakedown = baronTakedown;
